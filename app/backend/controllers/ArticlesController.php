...
use aiur\services\ArticleService;
...
class ArticlesController extends AccessController
{
    ...
    public function __construct( $id, $module, ArticlesRepository $repo, ArticleService $service, array $config = [] )
    {
    ...
    public function actionAdd()
    {
        if( \Yii::$app->request->isPost )
        {
            ...
            $row = $this->service->create($fd);
            return $this->redirect(['articles/update', 'id' => $row->id]);
        }
